...
public class AsynchronousFileChannelTest3 {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		try {
			...
			FileAttribute[] attrs1 = new FileAttribute[]{
					...
					//		at sun.nio.fs.WindowsSecurityDescriptor.fromAttribute(WindowsSecurityDescriptor.java:355)
			...
			channel1 = AsynchronousFileChannel.open(file1, EnumSet.of(StandardOpenOption.CREATE, StandardOpenOption.READ,
					StandardOpenOption.WRITE), threadPoolExecutor, attrs1);
			...
			// System.out.println("文件路径:" + file.normalize().toAbsolutePath());
			channel2 = AsynchronousFileChannel.open(file2, EnumSet.of(StandardOpenOption.CREATE, StandardOpenOption.READ,
					StandardOpenOption.WRITE), threadPoolExecutor);
	...
	private static FileAttribute newFileAttributeACL(Path file) throws IOException {
		...
		AclEntry entry = AclEntry.newBuilder()
				...
				.setPermissions(AclEntryPermission.READ_DATA, AclEntryPermission.READ_ATTRIBUTES, AclEntryPermission.WRITE_DATA, AclEntryPermission.WRITE_ATTRIBUTES, AclEntryPermission.DELETE)
				.build();
	...
	private static void printFileAttr(Path file) {
		try {
			...
			UserDefinedFileAttributeView udfav = Files.getFileAttributeView(file,
